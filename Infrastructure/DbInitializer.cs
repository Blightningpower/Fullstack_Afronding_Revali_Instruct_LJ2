...
";
            ...
            if (await TableExistsAsync(context, "Patients"))
            {
                ...
                if (patientsCount == 0)
                {
                    // Twee voorbeeldpatiënten voor US1-lijst:
                    // - Jan: Intake gepland
                    // - Maria: Actief traject
                    var p1 = new Patient
                    {
                        FirstName = "Jan",
                        LastName = "Jansen",
                        ...
                        StartDate = DateTime.Today,                  // startdatum traject
                        Status = PatientStatus.IntakePlanned,        // 'Intake gepland'
                    ...
                    var p2 = new Patient
                    {
                        ...
                        StartDate = DateTime.Today.AddDays(-7),      // al een week bezig
                        Status = PatientStatus.Active,               // 'Actief'
                        AssignedDoctorUserId = doctorId
                    };
